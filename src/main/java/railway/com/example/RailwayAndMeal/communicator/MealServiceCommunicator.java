...
public class MealServiceCommunicator {
	...
	/**
	  The "deleteMeal()" method by using the "exchange()"
	...
	/**
	  The "updateMeal()" method by using the "exchange()" method of the
	"RestTemplate" to make a put call to the given URL.
	**/
	public void updateMeal(Meal meal) {
		String url=baseURL+"/meal/"+meal;
		restTemplate.exchange(url,HttpMethod.PUT,null, Object.class);
